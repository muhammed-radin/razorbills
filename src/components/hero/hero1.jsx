        ...
        <div className="grid gap-8 lg:gap-12 lg:grid-cols-2 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl font-semibold text-primary animate-slide-up delay-100">
                {subheading}
              </p>
            </div>

            {/* Description */}
            <p className="text-muted-foreground text-base sm:text-lg md:text-xl max-w-xl animate-slide-up delay-200">
              {description}
            </p>
