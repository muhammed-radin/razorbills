...
const slides = [
  {
    ...
    description:
      "Immerse yourself in crystal-clear audio with our flagship headphones featuring active noise cancellation.",
  ...
  },
  {
    ...
    description:
      "Create the perfect ambiance with customizable RGB LED strips. Control via app or voice.",
    image:
      "https://img.magnific.com/free-photo/modern-stationary-collection-arrangement_23-2149309643.jpg",
    price: 1499,
    originalPrice: 2499,
    badge: "New Arrival",
    theme: "amber",
  },
  {
    ...
    description:
      "Never run out of power with our high-capacity portable battery. Fast charging for all devices.",
    image: "/mockup-1.png",
    price: 3499,
    originalPrice: 4999,
  ...
  },
  {
    ...
    description:
      "Bring the concert home with our powerful speaker system. Deep bass, crisp highs.",
...
export default function HighlightedSlider({
  ...
  return (
    <section
      className={cn(
        "relative w-full my-4 sm:my-8 md:my-12 overflow-hidden max-w-7xl mx-auto",
        className,
      )}
    >
