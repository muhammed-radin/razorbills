...
export default function ListHorizontalProductCards({ products = [] }) {
  ...
  const demoProducts = [
    {
      ...
      description:
        "Experience crystal-clear audio with active noise cancellation and premium sound quality.",
      price: 89.99,
    ...
    },
    {
      ...
      description:
        "Track your health metrics, sleep patterns, and daily activities with precision.",
      price: 49.99,
      originalPrice: 79.99,
      rating: 4.3,
      reviews: 256,
    },
    {
      ...
      description:
        "Powerful bass and 360° sound in a compact, waterproof design for any adventure.",
      price: 59.99,
      originalPrice: 89.99,
      rating: 4.7,
      reviews: 312,
    },
    {
      ...
      description:
        "65W fast charging for laptops, tablets, and phones with intelligent power delivery.",
      price: 29.99,
      originalPrice: 49.99,
      rating: 4.8,
      reviews: 445,
    },
    {
      ...
      description:
        "RGB backlit keys with tactile switches for the ultimate gaming experience.",
      price: 79.99,
    ...
    },
    {
      ...
      description:
        "Comfortable design with adjustable DPI settings for all-day productivity.",
      price: 39.99,
      originalPrice: 59.99,
      rating: 4.4,
      reviews: 267,
  ...
  const displayProducts = products.length > 0 ? products : false;

  if (!displayProducts) {
    return <br />; // Render nothing if no products to display
  }
