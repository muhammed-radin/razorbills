    ...
    >
      ...
      <div
        className={cn(
          ...
          isNewArrivals &&
            "bg-gradient-to-br from-violet-500/40 via-primary/30 to-fuchsia-500/40",
          isTopRated &&
            "bg-gradient-to-br from-amber-400/40 via-orange-500/30 to-rose-500/40",
          !isNewArrivals &&
            !isTopRated &&
            "bg-gradient-to-br from-cyan-500/40 via-blue-500/30 to-indigo-500/40",
        )}
      />
        ...
        <CardContent className="p-3 sm:p-4 space-y-2">
          ...
          <h3
            className={cn(
              ...
              isNewArrivals &&
                "group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-fuchsia-600",
              isTopRated &&
...
export default function ModernCarousel({
  ...
  const accentColor = isNewArrivals
    ? "primary"
    : isTopRated
      ? "amber-500"
      : "primary";
